...
namespace Alpha.Integracoes.NFSe.Models.CancelarNfseResposta
{
	...
	[XmlRoot(ElementName = "RetCancelamento", Namespace = "http://www.abrasf.org.br/nfse")]
	public class RetCancelamento
	{
		[XmlElement(ElementName = "NfseCancelamento", Namespace = "http://www.abrasf.org.br/nfse")]
		public List<NfseCancelamento> NfseCancelamento { get; set; }
	}

	[XmlRoot(ElementName = "CancelarNfseResposta", Namespace = "http://www.abrasf.org.br/nfse")]
	public class CancelarNfseResposta
	{
		[XmlElement(ElementName = "RetCancelamento", Namespace = "http://www.abrasf.org.br/nfse")]
		public RetCancelamento RetCancelamento { get; set; }
		[XmlAttribute(AttributeName = "xmlns")]
		public string Xmlns { get; set; }
	}
