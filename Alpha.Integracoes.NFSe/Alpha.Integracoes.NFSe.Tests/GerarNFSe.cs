...
namespace NFS_e
{
    public partial class FormGerarNFSe : Form
    {
        ...
        private async void btnEnviarRPS_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var service = new NfseServicesClient(new BasicHttpsBinding(BasicHttpsSecurityMode.Transport), new EndpointAddress("https://www4.webiss.com.br/cacoalro_wsnfse_homolog/NfseServices.svc?wsdl"));
